...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_history, container, false);
        ...
        GraphView graphView = view.findViewById(R.id.water_usage_history_graph);
        ...
        PointsGraphSeries<DataPoint> pointsGraphSeries = new PointsGraphSeries<DataPoint>(new DataPoint[] {
                new DataPoint(0, 100),
                new DataPoint(1, 500),
                new DataPoint(2, 300),
                new DataPoint(3, 200),
